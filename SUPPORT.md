...
`vgi-sklearn` is developed and maintained by **[Query.Farm](https://query.farm)**.
It is a [VGI](https://query.farm) worker that exposes
[scikit-learn](https://scikit-learn.org) — datasets, metrics, transforms, and a
train/predict model registry — to DuckDB/SQL.
...
- **Issues:** https://github.com/query-farm/vgi-scikit-learn/issues
